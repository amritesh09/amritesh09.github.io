...
function SendContactMeQuery($name, $email, $tel, $message) {
	...
	try {
		...
		// first send the mail to query@amriteshsrivastava.com
		$adminMessage = "Dear Admin, <br /><br /> Please find the query below, from the contact-me page of AmriteshSrivastava.com: <br /><br />";
		...
		$queryMessage .= "Thank you. <br />Amritesh Srivastava, <br />query@amriteshsrivastava.com";
